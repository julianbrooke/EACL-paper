...
\texttt{julian.brooke@gmail.com, tb@lwin.net} \\
	...
	\Function{LocalOpt}{$Y_{\mathit{start}}, x, X_{\mathit{rev}}, X_{\mathit{aff}}$}
		...
		\Repeat
			...
			\For{$x_{\mathit{rev}} \textrm{ in } X_{\mathit{rev}}$}
					...
					\State $e_{\mathit{new}} \gets\Call{CalcExpl}{s_{\mathit{new}}, X_{\mathit{aff}}}$
...
The second author has been supported by an Endeavour Research Fellowship
of the Australian Government, and in part by the Croatian Science
Foundation under the project UIP-2014-09-7312. We would also like to thank our Australian, Japanese, and Croatian annotators.
